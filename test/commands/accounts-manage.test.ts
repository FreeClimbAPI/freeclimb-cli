...
label:"userInput-label",})
    ...
    describe("accounts:manage body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}` , {
alias:"userInput-alias",})
        .query({})
...
label:"userInput-label",})
    ...
    .it("required params and a body param is sent through with request-label", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("accounts:manage next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

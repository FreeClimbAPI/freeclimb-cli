...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers/${phoneNumberId}` , {})
        .query({})
...
alias:"userInput-alias",})
    ...
    .stdout()
    .command(["incoming-numbers:update","userInput-phoneNumberId","--applicationId","userInput-applicationId","--alias","userInput-alias"])
    ...
    describe("incoming-numbers:update body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers/${phoneNumberId}` , {
applicationId:"userInput-applicationId",})
        .query({})
    ...
    .stdout()
    .command(["incoming-numbers:update","userInput-phoneNumberId","--applicationId","userInput-applicationId"])
    .it("required params and a body param is sent through with request-applicationId", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
alias:"userInput-alias",})
    ...
    .stdout()
    .command(["incoming-numbers:update","userInput-phoneNumberId","--alias","userInput-alias"])
    ...
    describe("incoming-numbers:update next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers/${phoneNumberId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

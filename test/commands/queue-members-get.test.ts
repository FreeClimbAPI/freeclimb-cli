...
describe("queue-members:get Data Test", function () {
  ...
  "message": "Response from server"
    ...
    test.nock("https://www.freeclimb.com", async (api) =>
        ...
        .stdout()
        .command(["queue-members:get", "userInput-queueId", "userInput-callId"])
    ...
    describe("queue-members:get next flag test", function () {
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({ FREECLIMB_QUEUE_MEMBERS_GET_NEXT: undefined })
            .command(["queue-members:get", "userInput-queueId", "userInput-callId"])
            .command(["queue-members:get", "userInput-queueId", "userInput-callId", "--next"])
            .exit(3)
        ...
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({ FREECLIMB_QUEUE_MEMBERS_GET_NEXT: "71756575652d6d656d626572733a676574" })
            .command(["queue-members:get", "userInput-queueId", "userInput-callId", "--next"])
            .it(
        ...
        before(() => {
            ;(async () => {
                testJsonNext2.nextPageUri = `https://www.freeclimb.com/apiserver/Accounts/${await cred.accountId}/Queues/${queueId}/Members/${callId}?cursor=${finalCursor}`
            })()
        })
        after(() => {
            const dataDir = data.run([]).then(
                (dataDir) => {
                    ...
                    environment.clearString("FREECLIMB_QUEUE_MEMBERS_GET_NEXT")
                },

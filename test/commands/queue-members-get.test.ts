...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Queues/${queueId}/Members/${callId}` , {})
        .query({})
...
test
    .stdout()
    .command(["queue-members:get","userInput-queueId","userInput-callId","additionalArguments"])
    .exit(2)
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("queue-members:get next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Queues/${queueId}/Members/${callId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

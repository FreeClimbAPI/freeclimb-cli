...
smsFallbackUrl:"userInput-smsFallbackUrl",})
    ...
    .stdout()
    .command(["applications:create","--alias","userInput-alias","--voiceUrl","userInput-voiceUrl","--voiceFallbackUrl","userInput-voiceFallbackUrl","--callConnectUrl","userInput-callConnectUrl","--statusCallbackUrl","userInput-statusCallbackUrl","--smsUrl","userInput-smsUrl","--smsFallbackUrl","userInput-smsFallbackUrl"])
    ...
    describe("applications:create body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Applications` , {
alias:"userInput-alias",})
        .query({})
...
smsFallbackUrl:"userInput-smsFallbackUrl",})
    ...
    describe("applications:create next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Applications` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

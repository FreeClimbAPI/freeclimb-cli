...
test
    .stdout()
    .command(["accounts:get","additionalArguments"])
    .exit(2)
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("accounts:get next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    .stdout()
    .env({"FREECLIMB_ACCOUNTS_GET_NEXT":undefined})
    .command(["accounts:get"])
    .command(["accounts:get","--next"])
    .exit(3)

...
maxSize:10,})
    ...
    describe("call-queues:create body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Queues` , {
alias:"userInput-alias",})
        .query({})
...
test
    ...
    describe("call-queues:create next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Queues` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

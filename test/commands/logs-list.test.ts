...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("logs:list maxItem flag test", function () {const testJsonLogs = {
  "message": "Response from server",
  "logs": [
    {
      "logNum": 1,
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("logs:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Logs` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

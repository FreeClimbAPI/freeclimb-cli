...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Recordings/${recordingId}/Download` , {})
        .query({})
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("recordings:download next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Recordings/${recordingId}/Download` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

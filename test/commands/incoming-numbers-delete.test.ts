...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .delete(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers/${phoneNumberId}` , {})
        .query({})
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("incoming-numbers:delete next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .delete(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers/${phoneNumberId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {})
        .query({})
...
test
    .stdout()
    .command(["conference-participants:get","userInput-conferenceId","userInput-callId","additionalArguments"])
    .exit(2)
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("conference-participants:get next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    .command(["conference-participants:get","userInput-conferenceId","userInput-callId"])
    .command(["conference-participants:get","userInput-conferenceId","userInput-callId","--next"])
    .exit(3)

...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("applications:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Applications` , {})
        .query({
alias:"userInput-alias",})
    ...
    describe("applications:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Applications` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

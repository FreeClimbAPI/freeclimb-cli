...
phoneNumber:"userInput-phoneNumber",})
    ...
    .stdout()
    .command(["available-numbers:list","--alias","123-456-7890","--country","userInput-country","--region","userInput-region","--smsEnabled","true","--voiceEnables","true","--phoneNumber","userInput-phoneNumber"])
    ...
    describe("available-numbers:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/AvailablePhoneNumbers` , {})
        .query({
alias:"123-456-7890",})
...
phoneNumber:"userInput-phoneNumber",})
    ...
    describe("available-numbers:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/AvailablePhoneNumbers` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
...
const testJsonNext2 = {
  ...
  "nextPageUri": ""
    ...
    .stdout()
    .env({"FREECLIMB_AVAILABLE_NUMBERS_LIST_NEXT":"617661696c61626c652d6e756d626572733a6c697374"})
    .command(["available-numbers:list","--next"])
...
const finalCursor = "freeClimbCLIAutomatedTestCursor"
    ...
    describe("available-numbers:list boolean input test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/AvailablePhoneNumbers` , {})
        .query({
alias:"123-456-7890",
...
phoneNumber:"userInput-phoneNumber",})
    ...
    .stdout()
    .command(["available-numbers:list","--alias","123-456-7890","--country","userInput-country","--region","userInput-region","--smsEnabled","false","--voiceEnables","false","--phoneNumber","userInput-phoneNumber"])

...
test
    .stdout()
    .command(["sms:send","userInput-from","userInput-to","userInput-text","additionalArguments"])
    .exit(2)
...
text:"userInput-text",})
    ...
    describe("sms:send body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Messages` , {
from:"userInput-from",
to:"userInput-to",
...
notificationUrl:"userInput-notificationUrl",})
    ...
    .stdout()
    .command(["sms:send","userInput-from","userInput-to","userInput-text","--notificationUrl","userInput-notificationUrl"])
    .it("required params and a body param is sent through with request-notificationUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("sms:send next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Messages` , {
from:"userInput-from",
to:"userInput-to",

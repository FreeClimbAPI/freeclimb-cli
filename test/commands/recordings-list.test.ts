...
dateCreated:"userInput-dateCreated",})
    ...
    .stdout()
    .command(["recordings:list","--callId","userInput-callId","--conferenceId","userInput-conferenceId","--dateCreated","userInput-dateCreated"])
    ...
    describe("recordings:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Recordings` , {})
        .query({
callId:"userInput-callId",})
    ...
    .it("required params and a query param is sent through with request-callId", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
conferenceId:"userInput-conferenceId",})
    ...
    .it("required params and a query param is sent through with request-conferenceId", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
dateCreated:"userInput-dateCreated",})
    ...
    describe("recordings:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Recordings` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

...
test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {})
        .query({})
...
test
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","additionalArguments"])
    .exit(2)
...
listen:true,})
    ...
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--talk","true","--listen","true"])
    ...
    describe("conference-participants:update body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {
talk:true,})
        .query({})
    ...
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--talk","true"])
    .it("required params and a body param is sent through with request-talk", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
listen:true,})
    ...
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--listen","true"])
    .it("required params and a body param is sent through with request-listen", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("conference-participants:update next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId"])
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--next"])
    .exit(3)
    .it("Tests return of Exit Code 3 when flag next is not available")

})

    describe("conference-participants:update boolean input test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences/${conferenceId}/Participants/${callId}` , {
talk:false,
listen:false,})
    ...
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--talk","false","--listen","false"])
...
test
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--talk","flse"])
    .exit(2)
    .it("tests incorrect talk input results in exit code 2")

test
    .stdout()
    .command(["conference-participants:update","userInput-conferenceId","userInput-callId","--listen","flse"])
    .exit(2)

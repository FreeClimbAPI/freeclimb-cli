...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    .stdout()
    .command(["applications:delete","userInput-applicationId"])
...
test
    .stdout()
    .command(["applications:delete","userInput-applicationId","additionalArguments"])
    .exit(2)
...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("applications:delete next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .delete(`/apiserver/Accounts/${await cred.accountId}/Applications/${applicationId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    .stdout()
    .env({"FREECLIMB_APPLICATIONS_DELETE_NEXT":undefined})
    .command(["applications:delete","userInput-applicationId"])
    .command(["applications:delete","userInput-applicationId","--next"])
    .exit(3)

...
direction:"userInput-direction",})
    ...
    .stdout()
    .command(["sms:list","--to","userInput-to","--from","userInput-from","--beginTime","userInput-beginTime","--endTime","userInput-endTime","--direction","userInput-direction"])
    ...
    describe("sms:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Messages` , {})
        .query({
to:"userInput-to",})
    ...
    .it("required params and a query param is sent through with request-to", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
from:"userInput-from",})
    ...
    .it("required params and a query param is sent through with request-from", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
beginTime:"userInput-beginTime",})
    ...
    .it("required params and a query param is sent through with request-beginTime", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
endTime:"userInput-endTime",})
    ...
    .it("required params and a query param is sent through with request-endTime", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
direction:"userInput-direction",})
    ...
    .it("required params and a query param is sent through with request-direction", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("sms:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Messages` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

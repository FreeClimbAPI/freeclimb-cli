...
active:true,})
    ...
    .stdout()
    .command(["calls:list","--to","userInput-to","--from","userInput-from","--status","userInput-status","--startTime","userInput-startTime","--endTime","userInput-endTime","--parentCallId","userInput-parentCallId","--active","true"])
    ...
    describe("calls:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Calls` , {})
        .query({
to:"userInput-to",})
...
status:"userInput-status",})
    ...
    .it("required params and a query param is sent through with request-status", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
startTime:"userInput-startTime",})
    ...
    .it("required params and a query param is sent through with request-startTime", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
parentCallId:"userInput-parentCallId",})
    ...
    .it("required params and a query param is sent through with request-parentCallId", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
active:true,})
    ...
    .it("required params and a query param is sent through with request-active", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("calls:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Calls` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
...
const finalCursor = "freeClimbCLIAutomatedTestCursor"
    ...
    describe("calls:list boolean input test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Calls` , {})
        .query({
to:"userInput-to",
...
active:false,})
    ...
    .stdout()
    .command(["calls:list","--to","userInput-to","--from","userInput-from","--status","userInput-status","--startTime","userInput-startTime","--endTime","userInput-endTime","--parentCallId","userInput-parentCallId","--active","false"])

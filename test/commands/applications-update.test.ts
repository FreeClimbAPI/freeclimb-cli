...
smsFallbackUrl:"userInput-smsFallbackUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--alias","userInput-alias","--voiceUrl","userInput-voiceUrl","--voiceFallbackUrl","userInput-voiceFallbackUrl","--callConnectUrl","userInput-callConnectUrl","--statusCallbackUrl","userInput-statusCallbackUrl","--smsUrl","userInput-smsUrl","--smsFallbackUrl","userInput-smsFallbackUrl"])
    ...
    describe("applications:update body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Applications/${applicationId}` , {
alias:"userInput-alias",})
        .query({})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--alias","userInput-alias"])
...
voiceUrl:"userInput-voiceUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--voiceUrl","userInput-voiceUrl"])
    .it("required params and a body param is sent through with request-voiceUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
voiceFallbackUrl:"userInput-voiceFallbackUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--voiceFallbackUrl","userInput-voiceFallbackUrl"])
    .it("required params and a body param is sent through with request-voiceFallbackUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
callConnectUrl:"userInput-callConnectUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--callConnectUrl","userInput-callConnectUrl"])
...
statusCallbackUrl:"userInput-statusCallbackUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--statusCallbackUrl","userInput-statusCallbackUrl"])
    .it("required params and a body param is sent through with request-statusCallbackUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
smsUrl:"userInput-smsUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--smsUrl","userInput-smsUrl"])
    .it("required params and a body param is sent through with request-smsUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
smsFallbackUrl:"userInput-smsFallbackUrl",})
    ...
    .stdout()
    .command(["applications:update","userInput-applicationId","--smsFallbackUrl","userInput-smsFallbackUrl"])
    .it("required params and a body param is sent through with request-smsFallbackUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("applications:update next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Applications/${applicationId}` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

...
test
    .stdout()
    .command(["conferences:list","additionalArguments"])
    .exit(2)
...
dateUpdated:"userInput-dateUpdated",})
    ...
    .stdout()
    .command(["conferences:list","--status","userInput-status","--alias","userInput-alias","--dateCreated","userInput-dateCreated","--dateUpdated","userInput-dateUpdated"])
    ...
    describe("conferences:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Conferences` , {})
        .query({
status:"userInput-status",})
    ...
    .stdout()
    .command(["conferences:list","--status","userInput-status"])
...
alias:"userInput-alias",})
    ...
    .stdout()
    .command(["conferences:list","--alias","userInput-alias"])
...
dateCreated:"userInput-dateCreated",})
    ...
    .stdout()
    .command(["conferences:list","--dateCreated","userInput-dateCreated"])
    .it("required params and a query param is sent through with request-dateCreated", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
dateUpdated:"userInput-dateUpdated",})
    ...
    .stdout()
    .command(["conferences:list","--dateUpdated","userInput-dateUpdated"])
    .it("required params and a query param is sent through with request-dateUpdated", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
    ...
    describe("conferences:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Conferences` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    .stdout()
    .env({"FREECLIMB_CONFERENCES_LIST_NEXT":undefined})
    .command(["conferences:list"])
...
const finalCursor = "freeClimbCLIAutomatedTestCursor"
    ...
    before(() => {(async () => {
        testJsonNext2.nextPageUri = `https://www.freeclimb.com/apiserver/Accounts/${await cred.accountId}/Conferences?cursor=${finalCursor}`
    })()})
    after(() => {
        const dataDir = data.run([]).then((dataDir) => {
            const environment = new Environment(dataDir)
            environment.clearString("FREECLIMB_CONFERENCES_LIST_NEXT")

...
describe("calls:list-call Data Test", function () {
  ...
  "message": "Response from server"
    ...
    test.nock("https://www.freeclimb.com", async (api) =>
        ...
        .stdout()
        .command(["calls:list-call", "userInput-callId"])
    ...
    test.stdout()
        .command(["calls:list-call", "userInput-callId", "additionalArguments"])
        .exit(2)
    ...
    describe("calls:list-call next flag test", function () {
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({ FREECLIMB_CALLS_LIST_CALL_NEXT: undefined })
            .command(["calls:list-call", "userInput-callId"])
            .command(["calls:list-call", "userInput-callId", "--next"])
            .exit(3)
        ...
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({ FREECLIMB_CALLS_LIST_CALL_NEXT: "63616c6c733a6c6973742d63616c6c" })
            .command(["calls:list-call", "userInput-callId", "--next"])
            .it(
        ...
        before(() => {
            ;(async () => {
                testJsonNext2.nextPageUri = `https://www.freeclimb.com/apiserver/Accounts/${await cred.accountId}/Calls/${callId}/Recordings?cursor=${finalCursor}`
            })()
        })
        after(() => {
            const dataDir = data.run([]).then(
                (dataDir) => {
                    ...
                    environment.clearString("FREECLIMB_CALLS_LIST_CALL_NEXT")
                },

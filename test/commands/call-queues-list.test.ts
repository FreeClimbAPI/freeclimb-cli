...
test.nock("https://www.freeclimb.com", async (api) =>
    ...
    describe("call-queues:list query param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Queues` , {})
        .query({
alias:"userInput-alias",})
    ...
    describe("call-queues:list next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .get(`/apiserver/Accounts/${await cred.accountId}/Queues` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })

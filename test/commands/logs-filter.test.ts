...
pql:"userInput-pql='error'",})
    ...
    describe("logs:filter maxItem flag test", function () {const testJsonLogs = {
  "message": "Response from server",
  "logs": [
    {
      "logNum": 1,
...
pql:"userInput-pql",})
    ...
    describe("logs:filter next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Logs` , {
pql:"userInput-pql",})
        .query({})

...
statusCallbackUrl:"userInput-statusCallbackUrl",})
    ...
    .stdout()
    .command(["conferences:create","--alias","userInput-alias","--playBeep","userInput-playBeep","--record","true","--waitUrl","userInput-waitUrl","--statusCallbackUrl","userInput-statusCallbackUrl"])
    ...
    describe("conferences:create body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences` , {
alias:"userInput-alias",})
        .query({})
...
record:true,})
    ...
    .it("required params and a body param is sent through with request-record", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
waitUrl:"userInput-waitUrl",})
    ...
    .it("required params and a body param is sent through with request-waitUrl", async (ctx) => {
        expect(ctx.stdout).to.contain(nockServerResponse)
...
statusCallbackUrl:"userInput-statusCallbackUrl",})
    ...
    describe("conferences:create next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences` , {})
        .query({})
        .basicAuth({ user: await cred.accountId, pass: await cred.apiKey })
    ...
    describe("conferences:create boolean input test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/Conferences` , {
alias:"userInput-alias",
playBeep:"userInput-playBeep",
...
statusCallbackUrl:"userInput-statusCallbackUrl",})
    ...
    .stdout()
    .command(["conferences:create","--alias","userInput-alias","--playBeep","userInput-playBeep","--record","false","--waitUrl","userInput-waitUrl","--statusCallbackUrl","userInput-statusCallbackUrl"])

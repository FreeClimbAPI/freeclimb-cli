...
describe("calls:list-call-logs Data Test", function () {
  ...
  "message": "Response from server"
    ...
    test.nock("https://www.freeclimb.com", async (api) =>
        ...
        .stdout()
        .command(["calls:list-call-logs", "userInput-callId"])
    ...
    test.stdout()
        .command(["calls:list-call-logs", "userInput-callId", "additionalArguments"])
        .exit(2)
    ...
    describe("calls:list-call-logs next flag test", function () {
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({ FREECLIMB_CALLS_LIST_CALL_LOGS_NEXT: undefined })
            .command(["calls:list-call-logs", "userInput-callId"])
            .command(["calls:list-call-logs", "userInput-callId", "--next"])
            .exit(3)
        ...
        test.nock("https://www.freeclimb.com", async (api) =>
            ...
            .stdout()
            .env({
                FREECLIMB_CALLS_LIST_CALL_LOGS_NEXT: "63616c6c733a6c6973742d63616c6c2d6c6f6773",
            })
            .command(["calls:list-call-logs", "userInput-callId", "--next"])
            .it(

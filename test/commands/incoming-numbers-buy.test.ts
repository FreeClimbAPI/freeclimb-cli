...
applicationId:"userInput-applicationId",})
    ...
    .stdout()
    .command(["incoming-numbers:buy","userInput-phoneNumber","--alias","userInput-alias","--applicationId","userInput-applicationId"])
    ...
    describe("incoming-numbers:buy body param flags", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers` , {
phoneNumber:"userInput-phoneNumber",
alias:"userInput-alias",})
    ...
    .stdout()
    .command(["incoming-numbers:buy","userInput-phoneNumber","--alias","userInput-alias"])
...
applicationId:"userInput-applicationId",})
    ...
    .stdout()
    .command(["incoming-numbers:buy","userInput-phoneNumber","--applicationId","userInput-applicationId"])
    ...
    describe("incoming-numbers:buy next flag test", function () {test.nock("https://www.freeclimb.com", async (api) =>
    api
        .post(`/apiserver/Accounts/${await cred.accountId}/IncomingPhoneNumbers` , {
phoneNumber:"userInput-phoneNumber",})
        .query({})

...
_See code: [src/commands/logs/filter.ts](https://github.com/Documents/freeclimb-cli/blob/v0.0.0/src/commands/logs/filter.ts)_
...
_See code: [src/commands/logs/list.ts](https://github.com/Documents/freeclimb-cli/blob/v0.0.0/src/commands/logs/list.ts)_

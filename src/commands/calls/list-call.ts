...
export class callsListCall extends Command {
    ...
    static flags = {
		dateCreated: flags.string({            char: "d",            description: "Only show recordings created on the specified date, in the form YYYY-MM-DD.",             required: false,             }),

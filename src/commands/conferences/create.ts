...
export class conferencesCreate extends Command {
    ...
    static flags = {
		...
		statusCallbackUrl: flags.string({            char: "s",            description: "This URL is invoked when the status of the Conference changes. For more information, see statusCallbackUrl (below).",             required: false,             }),
